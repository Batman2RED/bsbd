function dishes_tbl(count, dishes_tittle, dishes_price, dishes_img)
{
	...
	for (var i = 0; i < k; i++)
	{
		...
		for (var j = 0; j < 4; j++)
		{
			s += '<td><div class="product-item"><img src="'+ di_str[c] +' height=25%"><div class="product-list"><h3>'+ dt_str[c] +'</h3><span class="price">'+ dp_str[c] +' руб. </span><a class="button" href="cart.php?page=cart&action=add&id='+ dt_str[c] + '">В корзину</a></div></div></td>';
			c++;
		}
		s += "</tr>";
